...
@testset "Sum over polarization" begin
    ...
    # lineshape
    dc_Σb1 = DecayChainLS(1, (s,σ) -> BW(σ,mΣb,ΓΣb); tbs=tbs, two_s = 1, parity='+', Ps=['-','+','-','+'])
    dc_Σb3 = DecayChainLS(3, (s,σ) -> BW(σ,mΣb,ΓΣb); tbs=tbs, two_s = 1, parity='+', Ps=['-','+','-','+'])

    dc_Σb_x1 = DecayChainLS(1, (s,σ) -> BW(σ,mΣb_x,ΓΣb_x); tbs=tbs, two_s = 3, parity='+', Ps=['-','+','-','+'])
    dc_Σb_x3 = DecayChainLS(3, (s,σ) -> BW(σ,mΣb_x,ΓΣb_x); tbs=tbs, two_s = 3, parity='+', Ps=['-','+','-','+'])
