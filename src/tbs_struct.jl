...
Kibble31(σ3, σ1, tbs::ThreeBodySystem) = Kibble(tbs.s, circle(tbs.msq,1), circle([σ1,gσ2(σ3,σ1,tbs),σ3],1))
...
cosθ23(σ2,σ3,tbs::ThreeBodySystem) = cosθ12(tbs.s,circle(tbs.msq,2), circle([gσ1(σ2,σ3,tbs),σ2,σ3],2))
#
cos_mins_θhat2(σ3,σ1,tbs::ThreeBodySystem) = cosθhat12(tbs.s,        tbs.msq    ,        [σ1,gσ2(σ3,σ1,tbs),σ3])
cos_plus_θhat3(σ1,σ2,tbs::ThreeBodySystem) = cosθhat12(tbs.s, circle(tbs.msq,-1), circle([σ1,σ2,gσ3(σ1,σ2,tbs)],-1))
